...
if (isset($_POST["Submit"])) {
    ...
    $category->insert($data, "bookc", "Category added successfully", "book_category", "Something wrong");
}
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar  -->
        <?php $page = 'bookc';require_once 'page-section/sidebar.php'?>
                    ...
                    <div class="col-sm-8 header-title p-0">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h1 class="font-weight-bold">Book Category Adding</h1>
                                <small>From now on you can add a new category for Books.</small>
                            </div>
                        </div>
                    </div>
                </div>
