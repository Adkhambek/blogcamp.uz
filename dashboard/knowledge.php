...
if (isset($_POST["Submit"])) {
    ...
    $skill->insert($data, "knowladge", "Your skill added successfully", "knowledge", "Something wrong");
...
<head>
    ...
    <title>Dashboard: Knowledge</title>
    <!-- App favicon -->
...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar  -->
        <?php $page = 'knowledge';require_once 'page-section/sidebar.php'?>
                    ...
                    <div class="col-sm-8 header-title p-0">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h1 class="font-weight-bold">Skill Adding</h1>
                                <small>From now on you can add a new skill you can.</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 col-lg-10 mx-auto">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div>
                                        <h6 class="fs-17 font-weight-600 mb-0">Adding Skill</h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                            <label for="exampleFormControlSelect1" class="font-weight-600">Skill</label>
                                            <textarea id="summernote" name="info" required></textarea>
                                        </div>
