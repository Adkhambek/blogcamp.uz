...
<?php require_once 'include/telegram.php';?>
...
if (isset($_POST["Submit"])) {
    ...
    imageupload("social");
    $photo = "https://storage.kun.uz/source/6/A8WF4qKU1FF9Q9dFZweaAvj9Uf4wtGhg.jpg"; //.$image;
    send2(urlencode($title), urlencode($body), urlencode($photo));
...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar  -->
        <?php $page = 'telegram';require_once 'page-section/sidebar.php'?>
                    ...
                    <div class="col-sm-8 header-title p-0">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h1 class="font-weight-bold">Sending to Telegram</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-10 mx-auto">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="telegrams.php" method="post" enctype="multipart/form-data">
