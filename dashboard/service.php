...
if (isset($_POST["Submit"])) {
    ...
    $service->insert($data, "service", "Service added successfully", "service.php", "Something wrong");
...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar  -->
        <?php $page = 'service';require_once 'page-section/sidebar.php'?>
                    ...
                    <div class="col-sm-8 header-title p-0">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h1 class="font-weight-bold">Service Adding</h1>
                                <small>From now on you can add a new service.</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 col-lg-10 mx-auto">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div>
                                        <h6 class="fs-17 font-weight-600 mb-0">Adding Service</h6>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="font-weight-600">Service Name</label>
